...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center bg-gradient-beige overflow-hidden pt-20">
      {/* Accent Stripes */}
      <div className="absolute right-0 top-0 bottom-0 w-32 flex">
      ...
      {/* Background Image */}
      <div
        className="absolute right-40 top-0 bottom-0 w-1/2 opacity-15 bg-cover bg-center"
        style={{
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 relative z-10">
        ...
        >
          ...
          <a
            href="#contacto"
            className="inline-block bg-primary-blue text-white px-12 py-5 text-lg font-semibold rounded hover:bg-primary-dark-blue transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl"
          >
            Conocer más
          </a>
        </motion.div>
